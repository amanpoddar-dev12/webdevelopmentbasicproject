...
app.post("/submit", (req, res) => {
  ...
  res.render("index.ejs",{ adjective: adjRandom, noun: nounRandom
  });
...
// let adjRandom= +Math.random(0)*adj.length;
//   adjRandom=Number.parseInt(adjRandom)
//   let nounRandom= +Math.random(0)*noun.length;
//   nounRandom=Number.parseInt(nounRandom)
//   let RandomName=adj[adjRandom]+" "+noun[nounRandom]
//   console.log(RandomName)
